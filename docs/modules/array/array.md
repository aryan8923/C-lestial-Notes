...
The `array.c` module contains functions for **Vectors** which are 1-D arrays but support multiple data types including integers, precision floating-point numbers, and strings.
